...
group = "tech.digitaldojo.dojoscript"
version = "1.0-SNAPSHOT"
description = "Fast text formatting language for Java and Javascript. Lightweight and No Dependencies."
        ...
        jar {
            ...
            doFirst {
                manifest {
                    ...
                    attributes["DigitalDojo-AppId"] = "dojoscript"
